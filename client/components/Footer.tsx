        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 text-[#0f2a55]">
            {[
              ...
              { label: "Instagram", href: "https://www.instagram.com/adv.mangeshladhe/", svg: (<path d="M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm5 5a5 5 0 100 10 5 5 0 000-10zm6.5-.8a1.2 1.2 0 10-2.4 0 1.2 1.2 0 002.4 0z"/>) },
              { label: "LinkedIn", href: "https://www.linkedin.com/in/advocate-mangesh-ladhe-737422213/", svg: (<path d="M4.98 3.5C4.98 4.88 3.86 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 8h5v13H0zM9 8h4.7v1.8h.1c.7-1.2 2.4-2.5 4.9-2.5 5.2 0 6.2 3.4 6.2 7.8V21H20v-6.5c0-1.6 0-3.7-2.2-3.7s-2.6 1.7-2.6 3.6V21H9V8z"/>) },
            ].map(({label, href, svg}) => (
