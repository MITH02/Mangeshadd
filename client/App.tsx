...
const App = () => {
  useEffect(() => {
    ...
    setMeta(
      "description",
      "Advocate Mangesh Ladhe offers elite legal counsel for criminal, civil, constitutional, and corporate matters across India from the Bombay High Court, Nagpur Bench."
    );
    setMeta(
      "keywords",
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/placeholder/articles" element={<Articles />} />
